...
export class CDebugWebGLRenderingContext implements WebGLRenderingContext
{
    ...
    public uniform1f( location, x ): void
    {
        this.LogFunctionCall(
            'glUniform1f',
            location,
            x );
        this.mGL.uniform1f( location, x );
    };

    public uniform1fv( location, v ): void
    {
        this.LogFunctionCall(
            'glUniform1fv',
            location,
            v );
        this.mGL.uniform1fv( location, v );
    };

    public uniform1i( location, x ): void
    {
        this.LogFunctionCall(
            'glUniform1i',
            location,
            x );
        this.mGL.uniform1i( location, x );
    };

    public uniform1iv( location, v ): void
    {
        this.LogFunctionCall(
            'glUniform1iv',
            location,
            v );
        this.mGL.uniform1iv( location, v );
    };

    public uniform2f( location, x, y ): void
    {
        this.LogFunctionCall(
            'glUniform2f',
            location,
            x,
            y );
        this.mGL.uniform2f( location, x, y );
    };

    public uniform2fv( location, v ): void
    {
        this.LogFunctionCall(
            'glUniform2fv',
            location,
            v );
        this.mGL.uniform2fv( location, v );
    };

    public uniform2i( location, x, y ): void
    {
        this.LogFunctionCall(
            'glUniform2i',
            location,
            x,
            y );
        this.mGL.uniform2i( location, x, y );
    };

    public uniform2iv( location, v ): void
    {
        this.LogFunctionCall(
            'glUniform2iv',
            location,
            v );
        this.mGL.uniform2iv( location, v );
    };

    public uniform3f( location, x, y, z ): void
    {
        this.LogFunctionCall(
            'glUniform3f',
            location,
            ...
            y,
            z );
        this.mGL.uniform3f( location, x, y, z );
    };

    public uniform3fv( location, v ): void
    {
        this.LogFunctionCall(
            'glUniform3fv',
            location,
            v );
        this.mGL.uniform3fv( location, v );
    };

    public uniform3i( location, x, y, z ): void
    {
        this.LogFunctionCall(
            'glUniform3i',
            location,
            ...
            y,
            z );
        this.mGL.uniform3i( location, x, y, z );
    };

    public uniform3iv( location, v ): void
    {
        this.LogFunctionCall(
            'glUniform3iv',
            location,
            v );
        this.mGL.uniform3iv( location, v );
    };

    public uniform4f( location, x, y, z, w): void
    {
        this.LogFunctionCall(
            'glUniform4f',
            location,
            ...
            z,
            w );
        this.mGL.uniform4f( location, x, y, z, w );
    };

    public uniform4fv( location, v ): void
    {
        this.LogFunctionCall(
            'glUniform4fv',
            location,
            v );
        this.mGL.uniform4fv( location, v );
    };

    public uniform4i( location, x, y, z, w ): void
    {
        this.LogFunctionCall(
            'glUniform4i',
            location,
            ...
            z,
            w );
        this.mGL.uniform4i( location, x, y, z, w );
    };

    public uniform4iv( location, v ): void
    {
        this.LogFunctionCall(
            'glUniform4iv',
            location,
            v );
        this.mGL.uniform4iv( location, v );
    };

    public uniformMatrix2fv( location, transpose, v ): void
    {
        this.LogFunctionCall(
            'glUniformMatrix2fv',
            location,
            transpose,
            v );
        this.mGL.uniformMatrix2fv( location, transpose, v );
    };

    public uniformMatrix3fv( location, transpose, v ): void
    {
        this.LogFunctionCall(
            'glUniformMatrix3fv',
            location,
            transpose,
            v );
        this.mGL.uniformMatrix3fv( location, transpose, v );
    };

    public uniformMatrix4fv( location, transpose, v ): void
    {
        this.LogFunctionCall(
            'glUniformMatrix4fv',
            location,
            transpose,
            v );
        this.mGL.uniformMatrix4fv( location, transpose, v );
    };
